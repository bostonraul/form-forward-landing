...
import StoryLightbox from "@/components/StoryLightbox"; // Add this import
...
const Index = () => {
  ...
  2
              ...
              <h3 className="baby-font text-primary text-xl md:text-2xl font-bold mb-4">
                Connect and list with us!!
              </h3>
              <p className="text-primary/80 text-lg">
                Contact us to share the details and schedule a visit
              </p>
            </div>
  ...
  3
              ...
              <p className="text-primary/80 text-lg">
                We’ll take care of the logistics & give it to a parent in need
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-primary/80 text-lg md:text-xl mt-16">
          ...
          {showLightbox && <StoryLightbox onClose={() => setShowLightbox(false)} />}
        </div>
